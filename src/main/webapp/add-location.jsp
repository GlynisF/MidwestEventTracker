...
<div class="container">
    <form class="row g-3 mt-3 justify-content-between" action="event" method="post" id="autocompleteForm" autocomplete="off">
        <h2>Event Form</h2>
        ...
        <h2 id="location2">Location Form</h2>
        <div class="col-md-6">
...
<script>
    let placeId;
        ...
        $('#submit').on('click', function(event) {
            ...
            fetch('http://localhost:8080/MidwestEventTracker_war/services/location', {
                method: 'POST',
                headers: {
                ...
                .then(data => {
                    ...
                    //$('#resultContainer').html(`<p>Response Data: ${JSON.stringify(data)}</p>`);
                })
                .catch(error => {
                    console.error('Error:', error);

                    // Example: Update the UI with the error message
                    //$('#resultContainer').html(`<p>Error: ${error.message}</p>`);
                });
        });
