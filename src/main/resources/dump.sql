...
CREATE TABLE `artist` (
                          ...
                          CONSTRAINT `event_id` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-01-25 22:45:30